...
public enum DependencyRouterError: Error {
    ...
    case failureCreateFactory(Any.Type)    //Parameter: FactoryRouter type
    ...
    public var description: String {
        ...
        case .failureCreateFactory(let factoryType):
            return "Failure create factory router \(factoryType)"
        }
    }
